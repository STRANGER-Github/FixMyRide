    ...
    extend: {
      colors: {
        ...
        background: {
          ...
          "glass-strong": "hsl(var(--background-glass-strong))",
        },
        foreground: "hsl(var(--foreground))",
        
        /* Theme Colors */
        "midnight-blue": "hsl(var(--midnight-blue))",
        "midnight-blue-light": "hsl(var(--midnight-blue-light))",
        "neon-cyan": "hsl(var(--neon-cyan))",
        "neon-cyan-glow": "hsl(var(--neon-cyan-glow))",
        "sunset-orange": "hsl(var(--sunset-orange))",
        "sunset-orange-light": "hsl(var(--sunset-orange-light))",
        ...
        card: {
          ...
          "glass-strong": "hsl(var(--card-glass-strong))",
        },
        sidebar: {
