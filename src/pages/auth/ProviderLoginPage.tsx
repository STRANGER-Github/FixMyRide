...
import { Mail, Lock, Eye, EyeOff, Shield, Wrench } from "lucide-react";
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="glass-strong rounded-2xl p-8">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h1 className="text-2xl font-display font-bold">Provider Sign In</h1>
          </div>
          <p className="text-muted-foreground text-center text-sm mb-8">Access your provider dashboard</p>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            Don't have an account? <Link to="/auth/provider/register" className="text-primary hover:underline font-medium">Register</Link>
          </p>
        </div>
      </motion.div>
    </div>
